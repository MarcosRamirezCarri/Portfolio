...
return(
  <div className={`${ currentPage === 2 ? 'contents':'hidden' } lg:contents`}>
            ...
            >
            <p className="font-sans font-medium text-xl">Sobre mi?</p>
            <p className='font-sans  font-medium text-md relative top-[5vh]'>Algo de información para que me puedas conocer mejor</p>
