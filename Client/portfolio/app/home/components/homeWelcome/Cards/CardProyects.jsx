...
return(
  <div className={`${ currentPage === 1 ? 'contents':'hidden' } lg:contents`}>
    ...
    >
    <p className="font-sans font-medium text-xl">Mis proyectos?</p>
    <p className='font-sans  font-medium text-md relative top-[5vh]'>Proyectos o experiencias en las que he trabajado</p>
    <Image className='absolute place-self-center top-12 opacity-25 z-2 h-36 w-36' src={proyectImg} alt='project'/>
    <h1 className='font-sans text-center font-semibold text-lg relative top-[12vh] lg:top-[12vh]'>Estos son...</h1>
