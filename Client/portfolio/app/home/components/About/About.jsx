...
export default function About1 () {
    ...
    return(
        <div className="w-[95vw] lg:w-[65vw] h-[80vh] flex flex-col gap-5 lg:left-[9vw] lg:grid lg:grid-cols-2 relative m-12 lg:top-8">
            ...
            <h1 className="text-xl lg:text-2xl text-slate-800 relative font-medium [text-shadow:_2px_4px_8px_rgb(13_10_20_/_40%)] top-2 lg:top-10 font-normal underline decoration-2" >Te cuento un poco de mí</h1>
