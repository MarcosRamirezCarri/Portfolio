    ...
    <div className="h-screen -z-10 select-none w-screen bg-gradient-to-r from-blue-500 to-blue-300 -z-5 place-content-center grid overflow-hidden">
      ...
      <div className="animate">
        <div className={` ${expanded ? "expanded" : "circle"}`}>
          <div
            className={`absolute invisible lg:visible h-fit w-fit origin-center right-0 transition-all ${
          ...
          <Image
            ...
            height={420}
            src={IconoMio}
            className={`absolute h-48 w-48 visible top-[30vh] lg:invisible  ${
              expanded ? "hidden" : "content"
            } `}
            alt="IconMe"
          />
          {expanded ? (
            <div>
              <svg
                aria-hidden="true"
                className="w-24 h-24 text-blue-200 animate-spin fill-blue-600"
                viewBox="0 0 100 101"
                fill="none"
            ...
            <div className="relative flex flex-col w-[70vw] lg:w-fit h-full gap-2 lg:gap-5 text-center lg:text-left lg:right-32">
              <div className="gap-2 relative flex flex-col lg:flex-row">
                <h2 className="text-2xl lg:text-4xl text-slate-800 font-medium [text-shadow:_2px_4px_8px_rgb(13_10_20_/_40%)] font-normal">
                  Bienvenido a mi
                </h2>
                <h2 className="text-2xl lg:text-4xl text-blue-600 font-medium [text-shadow:_2px_4px_8px_rgb(13_10_20_/_40%)] lg:decoration-2 font-normal">
                  {" "}
                  Portfolio
                </h2>
              </div>
              <div className="gap-1 relative lg:left-0 text-center flex flex-row mt-12 lg:mt-20">
                <h2 className="text-md lg:text-3xl text-slate-800 font-medium [text-shadow:_2px_4px_8px_rgb(13_10_20_/_40%)] font-normal">
                  Soy
                </h2>
                <h2 className="text-md lg:text-3xl text-blue-600 font-medium [text-shadow:_2px_4px_8px_rgb(13_10_20_/_40%)] underline underline-offset-1 decoration-1 lg:decoration-2 font-normal">
                  Marcos Ramirez{" "}
                </h2>
              </div>
              <div className="gap-1 text-center lg:left-0  relative flex flex-row">
                ...
                <h2 className="text-md lg:text-3xl text-blue-600 font-medium [text-shadow:_2px_4px_8px_rgb(13_10_20_/_40%)] underline underline-offset-1 decoration-1 font-normal">
                  {" "}
                  Full Stack
                </h2>
              </div>
          ...
          <Link
            onClick={handleClick}
            className={`lg:w-max absolute place-self-center bottom-[1vh] lg:bottom-10 hover:scale-110 ease-in-out duration-300 ${
              expanded ? "hidden" : "content"
            } `}
            href="/home"
          >
            <BiCaretRightCircle className="h-20 w-20 drop-shadow-lg text-blue-500" />
          </Link>
        </div>
      </div>
    </div>
